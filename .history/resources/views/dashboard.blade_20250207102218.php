    ...
    <div class="modal d-nones text-center font-bold" id="modal">
        <div class="modal-dialog">
            ...
            <form class="modal-body">
                <p>
                    Welcome to Your ICoNDACoM 2025 Dashboard! <br>
We’re thrilled to have you on board for the 1st International Conference on New Developments in Applied and Computational Mathematics (ICoNDACoM 2025). This dashboard is your central hub to manage all conference-related activities, including abstract submission, registration, and tracking your application status.

How to Apply:
To submit your abstract, click on the "Submit Abstract" button. Complete the required fields, upload your document in the specified format, and review your information before submission. If you’re participating without a paper, proceed directly to the registration section to secure your place at the conference.
